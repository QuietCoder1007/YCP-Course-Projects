...
public class Pile {
	...
	public boolean isEmpty() {
		return (getNumCards() <= 0) ? true : false;
	}
	...
	public Card getCard(int index) {
		...
		if(index < 0 || index > getIndexOfTopCard()) {
