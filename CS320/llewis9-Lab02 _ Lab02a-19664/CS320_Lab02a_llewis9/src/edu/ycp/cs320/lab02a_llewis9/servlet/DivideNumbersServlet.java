...
public class DivideNumbersServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		System.out.println("DivideNumbers Servlet: doGet");	
		
		// call JSP to generate empty form
		req.getRequestDispatcher("/_view/divideNumbers.jsp").forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			} else if(model.getSecond() == 0 || model.getThird() == 0) {
				errorMessage = "Please don't break the calculator...";
			}
			...
			// thus, always call a controller method to operate on the data
				...
				if(model.getFirst() == null && model.getSecond() != null && model.getThird() != null){model.setFirst(1.0);}
				else if(model.getFirst() != null && model.getSecond() == null && model.getThird() != null){model.setSecond(1.0);}
				else if(model.getFirst() != null && model.getSecond() != null && model.getThird() == null){model.setThird(1.0);}
