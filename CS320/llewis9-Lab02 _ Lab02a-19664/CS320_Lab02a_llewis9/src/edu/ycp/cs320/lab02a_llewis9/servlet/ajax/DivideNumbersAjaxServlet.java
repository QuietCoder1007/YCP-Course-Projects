package edu.ycp.cs320.lab02a_llewis9.servlet.ajax;
...
public class DivideNumbersAjaxServlet extends HttpServlet {
	...
	private void doRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Double result = controller.divide(first, second, third);
